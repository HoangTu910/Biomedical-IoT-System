...
//Interrupt UART to receive data from STM32 and API Server
...
//Circular buffer get byte method
...
//Parsing frame, receive each byte from endpoint and define it as a frame structure
